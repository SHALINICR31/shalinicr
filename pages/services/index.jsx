...
const learningData = [
  ...
  { title: "Selenium Testing", date: "September 2025", pdfFile: "SELENIUM.pdf", // <-- replace images with PDF
    description: "Hands-on experience with Selenium for basic web automation and test case execution.", points: [ "Automated basic browser interactions using Selenium WebDriver", "Performed form submission and UI validation", "Executed simple test cases on web applications", ], },
